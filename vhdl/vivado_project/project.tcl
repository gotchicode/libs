...
#
# Generated by Vivado on Thu Apr 15 17:51:55 +0200 2021
...
#
#    "C:/Users/Jerome Fievet/Documents/Personal/Tech/libs/libs/vhdl/vivado_project/constraints.xdc"
#
# 3. The following remote source files that were added to the original project:-
#
#    "C:/Users/Jerome Fievet/Documents/Personal/Tech/libs/libs/vhdl/inv_chain/src/top.vhd"
#
#*****************************************************************************************
...
# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xc7a12tcpg238-3
...
set_property -name "part" -value "xc7a12tcpg238-3" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/../inv_chain/src/top.vhd"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../inv_chain/src/top.vhd"
...
set file "vivado_project/constraints.xdc"
...
set_property -name "target_part" -value "xc7a12tcpg238-3" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a12tcpg238-3 -flow {Vivado Synthesis 2020} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a12tcpg238-3 -flow {Vivado Implementation 2020} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
