...
in_enc_shift_reg = zeros(1,31);
out_enc_shift_reg = zeros(1,31);

in_dec_shift_reg = zeros(1,31);
out_dec_shift_reg = zeros(1,31);
...
%Scrambler
out_enc_table = pn_31_enc_1b(in_enc_table, in_enc_shift_reg, out_enc_shift_reg);
...
##%Descrambling
out_dec_table = pn_31_dec_1b(in_dec_table, in_dec_shift_reg, out_dec_shift_reg);
