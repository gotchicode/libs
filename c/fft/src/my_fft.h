...
int my_float_fft(float *data_in_re, float *data_in_im, float *data_out_re, float *data_out_im, float *fft_init_data_in_re, float *fft_init_data_in_im, float *dft_init_data_in_re, float *dft_init_data_in_im, int size, int max_size)
